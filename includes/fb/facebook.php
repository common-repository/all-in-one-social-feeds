...
*/ 
$config = array();
$config['appId'] = trim(get_option('netgo_facebook_app_id')); 
$config['secret'] =  trim(get_option('netgo_facebook_secret_key')); 
$pageid =  trim(get_option('netgo_facebook_page_id')); 
